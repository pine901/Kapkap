      ...
      <ValidationObserver ref="observer" v-slot="{ invalid , errors }" >
        <form class="form order">
          ...
          <div class="order__type">
            ...
            <input type="radio" name="rodzaj" value="prywatna" :checked="!billing.isCompany">
            <span>OSOBA PRYWATNA
          ...
          <label @click="setBusinessAddress">
            <input type="radio" name="rodzaj" value="firma" :checked="billing.isCompany">
            <span>NA FIRMĘ
              <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <notifications group="foo" class="error_notification"/>
      </form>
    </ValidationObserver>
  </div>
</section>
...
export default class OrderMobile extends OrderMixin {
}
</script>
