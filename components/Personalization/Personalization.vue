<template>
  <div>
    <Breadcrumb title="Personalizacja" />
    <section class="blog-detail-page section-b-space ratio2_3">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 blog-detail">
            <Picture path="@/assets/images/about/about-us.jpg" alt="blog" />
            <h3>Also the leap into electronic typesetting, remaining essentially unchanged.</h3>
            <ul class="post-social">
              <li>25 January 2018</li>
              <li>Opublikowany przez : Mariusz Buk</li>
              <li>
        ...
        <div class="row section-b-space blog-advance">
          <div class="col-lg-6">
            <div>
              <Picture path="@/assets/images/10.jpg" alt="blog-image" />
            </div>
          </div>
          <div class="col-lg-6">
            <div>
        ...
        <div class="row section-b-space">
          <div class="col-sm-12">
            <ul class="comment-section">
              <li>
                <div class="media">
                  <Picture path="@/assets/images/avtar.jpg" alt="Generic placeholder image" />
              ...
              <li>
                <div class="media">
                  <Picture path="@/assets/images/2.jpg" alt="Generic placeholder image" />
                  <div class="media-body">
                    <h6>
                      Mark Jecno
                      <span>( 12 Jannuary 2018 at 1:30AM )</span>
              ...
              <li>
                <div class="media">
                  <Picture path="@/assets/images/20.jpg" alt="Generic placeholder image" />
                  <div class="media-body">
                    <h6>
                      Mark Jecno
                      <span>( 12 Jannuary 2018 at 1:30AM )</span>
